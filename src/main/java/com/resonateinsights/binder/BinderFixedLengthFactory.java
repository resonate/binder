...
import com.resonateinsights.binder.annotation.Link;
 ...
 */
public class BinderFixedLengthFactory extends BinderAbstractFactory implements BinderFactory {

  private static final Logger LOG = LoggerFactory.getLogger(BinderFixedLengthFactory.class);
  ...
  public BinderFixedLengthFactory(PackageScanClassResolver resolver, String... packageNames) throws Exception {
  ...
  public BinderFixedLengthFactory(PackageScanClassResolver resolver, PackageScanFilter scanFilter, String... packageNames) throws Exception {
    super(resolver, packageNames, scanFilter);
    initFixedLengthModel();
  }

  public BinderFixedLengthFactory(PackageScanClassResolver resolver, Class<?> type) throws Exception {
    super(resolver, type);
  ...
  public BinderFixedLengthFactory(PackageScanClassResolver resolver, PackageScanFilter scanFilter, Class<?> type) throws Exception  {
