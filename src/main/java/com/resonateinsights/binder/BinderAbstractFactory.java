...
import com.resonateinsights.binder.util.AnnotationModelLoader;
...
/**
 * The {@link BinderAbstractFactory} implements what its common to all the formats
 * supported by Camel Binder
 */
public abstract class BinderAbstractFactory implements BinderFactory {
  private static final Logger LOG = LoggerFactory.getLogger(BinderAbstractFactory.class);
  ...
  public BinderAbstractFactory(PackageScanClassResolver resolver, String... packageNames) throws Exception {
  ...
  public BinderAbstractFactory(PackageScanClassResolver resolver, Class<?> type) throws Exception {
    this.modelsLoader = new AnnotationModelLoader(resolver);
    this.type = type;
  ...
  public BinderAbstractFactory(PackageScanClassResolver resolver, Class<?> type, PackageScanFilter scanFilter) throws Exception {
  ...
  public BinderAbstractFactory(PackageScanClassResolver resolver, String[] packageNames, PackageScanFilter scanFilter) throws Exception {
    this.modelsLoader = new AnnotationModelLoader(resolver, scanFilter);
    this.packageNames = packageNames;
