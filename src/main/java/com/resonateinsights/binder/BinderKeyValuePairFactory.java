...
import com.resonateinsights.binder.*;
...
/**
 * The BinderKeyValuePairFactory is the class who allows to bind data of type key
 ...
 */
public class BinderKeyValuePairFactory extends BinderAbstractFactory implements BinderFactory {

  private static final Logger LOG = LoggerFactory.getLogger(BinderKeyValuePairFactory.class);
  ...
  public BinderKeyValuePairFactory(PackageScanClassResolver resolver, String... packageNames) throws Exception {
  ...
  public BinderKeyValuePairFactory(PackageScanClassResolver resolver, Class<?> type) throws Exception {
    super(resolver, type);
