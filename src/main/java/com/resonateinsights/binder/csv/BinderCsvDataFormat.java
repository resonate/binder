...
import com.resonateinsights.binder.BinderCsvFactory;
...
import com.resonateinsights.binder.spi.DefaultContext;
 ...
 */
public class BinderCsvDataFormat extends BinderAbstractDataFormat {
  private static final Logger LOG = LoggerFactory.getLogger(BinderCsvDataFormat.class);

  public BinderCsvDataFormat() {
  }

  public BinderCsvDataFormat(String... packages) {
    super(packages);
  }

  public BinderCsvDataFormat(Class<?> type) {
    super(type);
  }

  public void marshal(Object body, OutputStream outputStream) throws Exception {
    marshal(new DefaultContext(), body, outputStream);
  }

  @SuppressWarnings("unchecked")
  public void marshal(Context context, Object body, OutputStream outputStream) throws Exception {

    BinderCsvFactory factory = (BinderCsvFactory)getFactory(context.getPackageScanClassResolver());
    ...
    if (factory.getGenerateHeaderColumnNames()) {
      ...
      String result = factory.generateHeader(body);
  ...
  protected BinderAbstractFactory createModelFactory(PackageScanClassResolver resolver) throws Exception {
    if (getClassType() != null) {
      return new BinderCsvFactory(resolver, getClassType());
    } else {
      return new BinderCsvFactory(resolver, getPackages());
    }
  }
}
